...
symbols = [
    Symbol("`", ["back tick"], ["grave", "back ticky"]),
    Symbol(",", ["comma", "coma"]),
    Symbol(".", ["period", "full stop"], ["dot", "point", "pebble"]),
    Symbol(";", ["semicolon"], ["semi", "semi coal"]),
    Symbol(":", ["colon"], ["coal"]),
    Symbol("?", ["question mark"], ["question", "questo"]),
    Symbol("!", ["exclamation mark", "exclamation point"], ["bang"]),
    Symbol("*", ["asterisk"], ["star"]),
    Symbol("#", ["hash sign", "number sign"], ["hash", "hash tag"]),
    ...
    Symbol("+", None, ["plus"]),
    Symbol("~", None, ["tilde"]),
    Symbol("_", None, ["down score", "underscore", "under bar"]),
    Symbol("(", ["paren", "left paren", "open round"]),
    Symbol(")", ["right paren", "close round"]),
    Symbol("[", None,["square", "open square",],),
    Symbol("]", None, ["close square", "right square"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["curly", "open curly"],),
    Symbol("}", None, ["close curly"]),
    Symbol("<", None, ["angle", "L Angle", "left angle", "less than", "open angle"]),
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than", "close angle"]),
    Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
    Symbol("'", None, ["quote", "apostrophe", "ticky"]),
    Symbol('"', None, ["dub quote", "double quote", "quad"]),
]
